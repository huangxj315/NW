...
class test_yflr():
    ...
    @allure.story("进入我的应付tab")
    # def test_yflrfdf(self,get_driver):
    #     #用户登录
    ...
    #         # 点击应付查询
    #         get_driver.get_element('entryvoucher', 'yfcx').click()
    #         # 输入应付单号关键字
    #         get_driver.get_element('entryvoucher', 'keyword').send_keys(billid)
    #         # 点击查询
    #         get_driver.get_element('entryvoucher', 'searchButton').click()
    #         sleep(2)
    #         #获取第一条数据财务凭证单号
    #         result1 = get_driver.get_element('entryvoucher', 'list_num1').get_attribute('innerText')
    #         assert result1 == billid

    # def test_yflrdf(self, get_driver):
    #     # 用户登录
    #     get_driver.start_houtai(1, '供应商')
    #     gmf = '安阳钢铁集团有限责任公司'
    #     xsf = '大唐电信科技股份有限公司'
    ...
    def test_yflrwz(self, get_driver):
        # 用户登录
        get_driver.start_houtai(1, '供应商')
        gmf = '安阳钢铁集团有限责任公司'
        xsf = '大唐电信科技股份有限公司'
